...
INDICATOR_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "sma":      {"label": "Simple Moving Average",      "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 500}}},
    "ema":      {"label": "Exponential Moving Average",  "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 500}}},
    "wma":      {"label": "Weighted Moving Average",     "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 500}}},
    "dema":     {"label": "Double EMA",                  "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 500}}},
    "tema":     {"label": "Triple EMA",                  "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 500}}},
    "hma":      {"label": "Hull Moving Average",         "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 500}}},
    "kama":     {"label": "Kaufman Adaptive MA",         "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 10, "type": "int", "min": 2, "max": 200}, "fast": {"default": 2, "type": "int", "min": 1, "max": 50}, "slow": {"default": 30, "type": "int", "min": 5, "max": 200}}},
    "smma":     {"label": "Smoothed Moving Average",     "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 500}}},
    "zlema":    {"label": "Zero-Lag EMA",                "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 500}}},
    "t3":       {"label": "T3 Moving Average",           "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 5, "type": "int", "min": 2, "max": 200}, "factor": {"default": 0.7, "type": "float", "min": 0.0, "max": 1.0}}},
    "alma":     {"label": "Arnaud Legoux MA",            "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 9, "type": "int", "min": 2, "max": 200}, "offset": {"default": 0.85, "type": "float", "min": 0.0, "max": 1.0}, "sigma": {"default": 6.0, "type": "float", "min": 0.1, "max": 20.0}}},
    "mcginley": {"label": "McGinley Dynamic",            "category": "trend",      "display": "overlay",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 14, "type": "int", "min": 2, "max": 200}}},
    "macd":     {"label": "MACD",                        "category": "trend",      "display": "panel",
                 "render": {"type": "composite", "parts": [
                     {"prefix": "MACD_",  "style": "line",      "label": "MACD"},
                     {"prefix": "MACDs_", "style": "line",      "label": "Signal"},
                     {"prefix": "MACDh_", "style": "histogram", "label": "Histogram"},
                 ]},
    ...
    "aroon":    {"label": "Aroon",                       "category": "trend",      "display": "panel",
                 "render": {"type": "multi_line", "lines": [
                     {"prefix": "AroonUp_",   "label": "Up",   "color": "#38bdf8"},
                     {"prefix": "AroonDown_", "label": "Down", "color": "#f472b6"},
                 ]},
                 "params": {"length": {"default": 25, "type": "int", "min": 2, "max": 200}}},
    "supertrend": {"label": "SuperTrend",                "category": "trend",      "display": "overlay",
                 "render": {"type": "colored_line", "above_color": "#f97316", "below_color": "#38bdf8"},
                 "params": {"atr_length": {"default": 10, "type": "int", "min": 2, "max": 100}, "mult": {"default": 3, "type": "int", "min": 1, "max": 10}}},
    "psar":     {"label": "Parabolic SAR",               "category": "trend",      "display": "overlay",
                 "render": {"type": "markers", "shape": "circle", "size": 0.5, "color": "#f59e0b"},
                 "params": {"af": {"default": 0.02, "type": "float", "min": 0.001, "max": 0.2}, "af_step": {"default": 0.02, "type": "float", "min": 0.001, "max": 0.1}, "max_af": {"default": 0.2, "type": "float", "min": 0.05, "max": 0.5}}},
    "dpo":      {"label": "Detrended Price Oscillator",  "category": "trend",      "display": "panel",
                 "render": {"type": "line", "levels": [0]},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 200}}},
    "trix":     {"label": "TRIX",                        "category": "trend",      "display": "panel",
                 "render": {"type": "line", "levels": [0]},
                 "params": {"length": {"default": 15, "type": "int", "min": 2, "max": 100}}},
    # ── Momentum ──
    "rsi":      {"label": "Relative Strength Index",     "category": "momentum",   "display": "panel",
                 "render": {"type": "line", "levels": [30, 70]},
                 "params": {"length": {"default": 14, "type": "int", "min": 2, "max": 100}}},
    "stoch":    {"label": "Stochastic Oscillator",       "category": "momentum",   "display": "panel",
                 "render": {"type": "multi_line", "lines": [
                     {"prefix": "STOCHk_", "label": "%K", "color": "#3b82f6"},
                     {"prefix": "STOCHd_", "label": "%D", "color": "#f97316"},
                 ], "levels": [20, 80]},
                 "params": {"k": {"default": 14, "type": "int", "min": 2, "max": 100}, "d": {"default": 3, "type": "int", "min": 1, "max": 50}}},
    "stochrsi": {"label": "Stochastic RSI",              "category": "momentum",   "display": "panel",
                 "render": {"type": "multi_line", "lines": [
                     {"prefix": "STOCHRSIk_", "label": "%K", "color": "#3b82f6"},
                     {"prefix": "STOCHRSId_", "label": "%D", "color": "#f97316"},
                 ], "levels": [20, 80]},
                 "params": {"rsi_length": {"default": 14, "type": "int", "min": 2, "max": 100}, "stoch_length": {"default": 14, "type": "int", "min": 2, "max": 100}, "k": {"default": 3, "type": "int", "min": 1, "max": 50}, "d": {"default": 3, "type": "int", "min": 1, "max": 50}}},
    "cci":      {"label": "Commodity Channel Index",     "category": "momentum",   "display": "panel",
                 "render": {"type": "line", "levels": [-100, 100]},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 200}}},
    "willr":    {"label": "Williams %R",                 "category": "momentum",   "display": "panel",
                 "render": {"type": "line", "levels": [-20, -80]},
                 "params": {"length": {"default": 14, "type": "int", "min": 2, "max": 100}}},
    "roc":      {"label": "Rate of Change",              "category": "momentum",   "display": "panel",
                 "render": {"type": "line", "levels": [0]},
                 "params": {"length": {"default": 10, "type": "int", "min": 1, "max": 200}}},
    "bop":      {"label": "Balance of Power",            "category": "momentum",   "display": "panel",
                 "render": {"type": "histogram"},
                 "params": {}},
    "uo":       {"label": "Ultimate Oscillator",         "category": "momentum",   "display": "panel",
                 "render": {"type": "line", "levels": [30, 70]},
                 "params": {"fast": {"default": 7, "type": "int", "min": 1, "max": 50}, "mid": {"default": 14, "type": "int", "min": 2, "max": 100}, "slow": {"default": 28, "type": "int", "min": 5, "max": 200}}},
    "tsi":      {"label": "True Strength Index",         "category": "momentum",   "display": "panel",
                 "render": {"type": "line", "levels": [0]},
                 "params": {"fast": {"default": 13, "type": "int", "min": 2, "max": 50}, "slow": {"default": 25, "type": "int", "min": 5, "max": 100}}},
    "ao":       {"label": "Awesome Oscillator",          "category": "momentum",   "display": "panel",
                 "render": {"type": "histogram"},
                 "params": {}},
    # ── Volatility ──
    "bbands":   {"label": "Bollinger Bands",             "category": "volatility", "display": "overlay",
                 "render": {"type": "bands", "upper_prefix": "BBU_", "middle_prefix": "BBM_", "lower_prefix": "BBL_", "fill_color": "rgba(59,130,246,0.08)"},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 200}, "std": {"default": 2.0, "type": "float", "min": 0.5, "max": 5.0}}},
    "atr":      {"label": "Average True Range",          "category": "volatility", "display": "panel",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 14, "type": "int", "min": 2, "max": 100}}},
    "natr":     {"label": "Normalised ATR",              "category": "volatility", "display": "panel",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 14, "type": "int", "min": 2, "max": 100}}},
    "kc":       {"label": "Keltner Channels",            "category": "volatility", "display": "overlay",
                 "render": {"type": "bands", "upper_prefix": "KCU_", "middle_prefix": "KCM_", "lower_prefix": "KCL_", "fill_color": "rgba(168,85,247,0.08)"},
                 "params": {"ma_length": {"default": 20, "type": "int", "min": 2, "max": 200}, "atr_length": {"default": 10, "type": "int", "min": 2, "max": 100}, "mult": {"default": 1.5, "type": "float", "min": 0.5, "max": 5.0}}},
    "donchian": {"label": "Donchian Channels",           "category": "volatility", "display": "overlay",
                 "render": {"type": "bands", "upper_prefix": "DCU_", "middle_prefix": "DCM_", "lower_prefix": "DCL_", "fill_color": "rgba(34,197,94,0.08)"},
                 "params": {"length": {"default": 20, "type": "int", "min": 2, "max": 200}}},
    "chop":     {"label": "Choppiness Index",            "category": "volatility", "display": "panel",
                 "render": {"type": "line", "levels": [38.2, 61.8]},
                 "params": {"length": {"default": 14, "type": "int", "min": 2, "max": 100}}},
    # ── Volume ──
    "obv":      {"label": "On-Balance Volume",           "category": "volume",     "display": "panel",
                 "render": {"type": "line"},
                 "params": {}},
    "sobv":     {"label": "Smoothed OBV",                "category": "volume",     "display": "panel",
                 "render": {"type": "line"},
                 "params": {"length": {"default": 5, "type": "int", "min": 2, "max": 50}}},
    "vwap":     {"label": "VWAP",                        "category": "volume",     "display": "overlay",
                 "render": {"type": "line"},
                 "params": {}},
    "ad":       {"label": "Accumulation/Distribution",   "category": "volume",     "display": "panel",
                 "render": {"type": "line"},
                 "params": {}},
    "force":    {"label": "Force Index",                 "category": "volume",     "display": "panel",
                 "render": {"type": "line", "levels": [0]},
                 "params": {"length": {"default": 13, "type": "int", "min": 2, "max": 100}}},
    "emv":      {"label": "Ease of Movement",            "category": "volume",     "display": "panel",
                 "render": {"type": "line", "levels": [0]},
                 "params": {"length": {"default": 14, "type": "int", "min": 2, "max": 100}}},
}
